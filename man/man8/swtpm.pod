...
one of the option parameters I<name=>, I<profile=>, or I<file=>.
...
=item B<--profile
name=E<lt>profile-nameE<gt>|profile=E<lt>json-profileE<gt>|file=E<lt>filenameE<gt>[,remove-disabled=check|fips-host]> (since v0.10)
