...
=item B<--key pwdfile=E<lt>passphrase fileE<gt>[,mode=aes-cbc][remove[=true|false]][,kdf=sha512|pbkdf2]>
...
=item B<--migration-key pwdfile=E<lt>passphrase fileE<gt>[,mode=aes-cbc][,remove[=true|false]][,pdf=sha512|pbkdf2]>
