...
In case ML-DSA or ML-KEM keys are used, the parameter must have the format
--ek pubkey=<hex digits>,algo=<algorithm>. Valid algorithms are for example
ml-kem-512, ml-kem-768, ml-kem-1024, ml-dsa-44, ml-dsa-65, and ml-dsa-87.
